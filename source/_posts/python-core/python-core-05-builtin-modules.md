---
title: Python教程核心章节 05：常用内建模块
slug: python-core-05-builtin-modules
date: 2026-03-17 16:04:00
updated: 2026-03-17 16:04:00
description: 廖雪峰Python教程核心章节整理（常用内建模块）
comments: true
toc: true
toc_number: true
copyright: true
...
> 系列导航：{% post_link python-core/python-core-index 总览 %} · 上一篇：{% post_link python-core/python-core-04-errors-debug-test 错误、调试和测试 %}
