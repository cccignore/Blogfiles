...
mathjax: false
katex: false
date: 2025-06-20 23:43:27
updated: 2025-06-20 23:43:27
tags: [考试复习]
categories:
  - [Python数据分析, 判断题]
cover: https://www.17golang.com/uploads/20250705/175168668468689e1cc0973.png
---
...
---
**8. 通过`isinstance(a, (int, str))`可以检测变量a的类型是否在int, str中 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**12. 对于对象`a=[1,2,3]`和`b=[1,2,3]`，`a is b`和`a==b`输出的结果都为True （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**26. 使用`pop( )`方法删除列表中某一元素后，该元素从栈顶被推出且无法再访问。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**28. 列表的插入函数`insert()`指定的序号可以大于数组长度。 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**29. List中的`remove()`函数会移除列表中指定的所有的元素。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**34. 已经`a=[1,2,3,4,5]`, `b=[6,7,8,9]`,则`a.append(b)`的输出结果是`[1,2,3,4,5,6,7,8,9]` ( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**4. NumPy中的`random`函数中的`randn()`可以产生N(0,1)的数（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**5. 使用`np.unique`函数可以对NumPy数组进行去重。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**7. 可以通过numpy中的`astype`方法显式地转换数组的数据类型。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**8. `np.arange()`是python内建函数的`range`的数组版（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**11. 数组生成函数`array`将输入数据转化为`ndarray`，默认复制所有的输入数据.（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**14. `data=np.random.randn(2,3)`，则`data.ndim`的输出结果是3（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**15. NumPy中的`zeros`方法和`empty`方法本质是一样的，都是创建一个全0的数组 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**17. 用NumPy数组对象的`reshape`方法变换维度时会改变原数组。 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**20. 多维Numpy数组的修改元素操作可使用tuple，例如`arr2d[(0,0)]=0`。 ( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**25. 如果`a.shape=（2，3，4）`，那么`a.mean(1).shape=（2，3）`( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**26. 输入`np.empty(10)`的结果为：`array([0., 0., ..., 0.])` ( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**29. 一个数组对象的`itemsize`，返回的值是由数组的大小决定的（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**30. 已知`x=np.array([3,5,1,9,6,3])`,那么表达式`np.argmax(x)`的值为3（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**33. `arr=[4,-1,9,16];np.sqrt(arr);arr` 以上代码输出的结果为`array([2,nan,3,4])` ( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
**1. `pd.isnull(frame)`与`pd.notnull(frame)`方法可以判断DataFrame对象frame中的元素是否缺失，返回布尔值DataFrame。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**2. 针对DataFrame在行上的标签索引`iloc`是左闭右开区间,`loc`是左闭右闭区间。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**3. 在DataFrame中，当A是有效的Python变量名时，`frame[‘A’]`与`frame.A`返回的结果是相同的（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**5. `pandas.to_datetime(date).year`可以实现从时间序列（data）中提取年份（ ）**
<details>
...
---
**6. 设有`s = pd.Series(np.arange(3))`，则`s.loc[:1]`，`s.iloc[:2]`，`s[:2]`输出的结果不一样（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**14. 在pandas中，通过`isnull`和`notnull`函数检查缺失数据，返回的结果是一样的（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**15. `ser=pd.Series(np.arange(3.))`，`ser.loc[:1]`和`ser.iloc[:1]`的结果是一样的（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**18. DataFrame的 `values`属性会把包含在DataFrame中的数据以NumPy数组的形式返回（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**19. 对于索引值为`[‘a’,’b’]`的Series对象obj，可以使用`obj[1]`获取值 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**21. `obj=...;`对于`obj`的切片，`obj["b":"c"]`,其输出值为 `b 1.0`。( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**23. `states = ('California', ...)`和`states = ['California', ...]`都可以执行的。( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**26. `a1`是一个Series，`a2`是一个DataFrame，他们都属于Pandas，但是`a1.values`和`a2.values`返回的数据类型不一样( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**28. `del`在DataFrame中只能够删除列不能够删除行。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**2. `pd.read_csv('examples/ex2.csv', header=0)`，`header = 0`表示取文件中的第一行作为列名。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**3. 使用`read_csv`方法读取文件时，可以通过指定`chunksize`进行分块读入文件( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**5. 使用`json.loads`方法可以将JSON字符串转化为python形式，使用`json.dumps`可以将python对象转化为JSON。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**6. DataFrame中的`to_csv`方法只能导出逗号分隔的文件（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**8. 当要读入的文件没有列名时，可以设置关键字`header=None`（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**9. 读取的字段由多种不同数量的空格分开时，我们可以通过向`sep`传入正则表达式来进行读取（ )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**10. CSV文件在写入的时候`data1=data.to_csv(...)`，其中`sep`参数用于制定分隔符（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**12. 将pandas数据写入到Excel格式中必须直接调用`ExcelWriter`（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**13. pandas中的函数`read_html`在默认的情况下会解析一个html页面中的所有标签，返回的结果是DataFrame对象的列表 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**14. 语句`options.display.max_rows`可以调整pandas的最大显示行数，设置显示最开始的行数.( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**15. 使用`read_csv()`方法读入文件的时候，默认的分隔符是”,”。 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**16. `na_values`可以接受一组用于表示缺失值的字符串 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**18. 当要读入的文件没有列名时，可以设置关键字`header=None` （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**19. 使用`read_table`方法读取文件时，可以传入`seq`参数指定分隔符 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**21. 在`read_csv`的参数中，`skiprows`传入的行号必须为列表形式( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**23. 当读取的txt文件中列名的数量比数据的列数少一个，因此`read_table`推断第一列应当作为DataFrame的索引。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**24. `panda.read_json`只能自动将JSON数据集按指定次序转换为Series（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**25. `...nrows=5` 和 `...chunker.get_chunk(5)` 输出结果一样( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**26. 使用`read_table`函数时，可以使用一个正则表达式作为分隔符。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**27. `read_csv`中的参数`header`默认为`None` （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**28. 为了分块读入文件，可以使用`chunksize`作为每一块的行数 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**30. `Pd.read_csv()`方法中，参数`header`和`names`同时设置最终以`names`作为基准设置列标签 ( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**31. 当要读入的文件没有列名时，可以设置关键字`header=0` （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**3. 默认情况下，`fillna`方法可以传入指定值来补全缺失值，从而修改了原对象（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**4. 在删除dataframe的某一行时,设置关键词`inplace=True`可以覆盖原有的数据。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**5. 对于DataFrame对象，`dropna`在默认情况下会删除所有值均为NA的行（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**7. `map`和`replace`都可以用于修改一个对象中的子集的值（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**9. Data为Series类型，操作`data[data.notnull()]`与`data.dropna()`是等价的。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**10. 使用pandas的`cut`操作返回的是一个DataFrame对象。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**12. Python中`in`关键字、`index`方法、`find`方法都可以检查子字符串（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**17. `data.index[0]='aaa'`可以将data中第0行的索引变为`aaa` （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**18. 通过`index`方法查找指定字符的位置，如果字符不存在会返回-1。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**19. `drop_duplicates`函数删除重复行，默认保留第一个观测到的值。 ( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**20. 对于存放数值型数据的DataFrame对象，调用`describe`方法可以返回各个列的统计数据 ( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**21. Python内建的`None`值在对象数组中也被当作NA处理。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**22. 使用`rename`方法对DataFrame对象`df`进行重命名将会返回一个新的对象。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**23. pandas中用`cut`函数进行分箱得到的分组区间只能是前开后闭（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**24. pandas中的`cut`函数可以通过传入参数实现两端均封闭。( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**25. 在DataFrame对象中，使用`fillna`来补全缺失值时，返回的是一个新对象。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**27. 语句`np.sign(data)`根据数据中的值的正负分别生成0和1的值 ( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**28. `dropna()`函数的`axis`和`how`参数的默认值分别为0，`any`( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**29. `fillna`方法的参数可以传入字典为不同列设置不同的填充值 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
**1. 默认情况下，`concat`方法是沿着`axis=0`的轴向生效的（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**2. NumPy中的`concatenate`函数默认情况下是进行横向拼接（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**3. `merge`函数会在没有指定连接键的情况下，自动将重叠列名作为连接的键（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**4. 如果不是所有的级别值都能在各分组中找到，则`unstack`操作会引入缺失数据（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**5. `swaplevel`接收两个层级序号或名称，将原对象的层级进行变更。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**8. DataFrame的`join`方法，能更为方便地实现按索引合并...但要求没有重叠的列（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**9. 一个分层索引的Series对象使用`unstack`方法会修改原对象（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**10. 使用`merge`函数进行列-列连接时，传递的DataFrame索引对象会被丢弃。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**11. 在使用`pandas.melt`的时候，需要指明作为分组目标的列（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**12. `combine_first`可用于拼接重复数据，用一个对象中的值填充另一个对象中的缺失值（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**13. 在数据透视表中，加入`margins=False`,可以在下方显示一些总和数据。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**15. 在分级索引中，可以通过`level`选项并通过改变轴向来进行聚合。 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**16. `unstack`操作的只能是最内层，`stack`也是如此 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**17. 默认情况下，`merge`函数会联合左连接和右连接的效果。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**18. 使用`merge`函数进行列-列连接时，传递的DataFrame索引对象会被丢弃。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**19. 通过给出层级排序函数`sort_index`函数中的`level`选项，可以指明对这一个层级的索引排序（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**20. `concat`函数对两个含有重叠索引的Series进行连接后，重叠索引对应的值为连接前两个重叠索引对应的值之和（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**21. DataFrame的`join`方法进行连接键上的左连接，完全保留左边DataFrame的行索引（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**22. 若一个具有二重行列索引的数据，使用`data.loc(axis=0)[0,1]`命令，获得的数据保留二重索引。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**24. `groupby()`后，使用`agg()`可以...但不能对不同的列使用不同的函数( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**25. 对两个Series数组调用`concat`方法，...如果设定`axis=1`，会生成一个DataFrame （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**26. DataFrame的`set_index`函数会生成一个新的DataFrame。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**28. `swaplevel`接收两个层级序号或层级名称，返回一个进行了层级变更的新对象（但是原数据是不变的）( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**29. `concat`函数中，`join`默认的连接方式是`'inner'`（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**30. `concat`函数中，如果传入了`keys`和/或`levels`参数，则该参数不能用于多层索引的层级名称（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**31. 在`concat`方法中传入参数`ignore_index`参数将忽略轴向索引 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**32. `merge`函数中`on`参数所需要连接的列名并不必须在两边的DataFrame对象中都出现。( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**33. ...`frame.reset_index(1)`和`frame.sort_index(level=1)`返回的结果相同。 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**2. DataFrame的`plot`方法可以在同一个子图中将每一列绘制为不同的折线，并自动生成图例（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**3. `matplotlib`和`seaborn`都是可以用于绘图的包。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**4. 在图表中添加图形时，需要生成patch对象`shp`，再调用`add_patch(shp)`将它加入到子图（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**5. `fig.add_subplot`返回的是Axes Subplot对象（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**7. `regplot`是`seaborn`中的绘制折线图的方法（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**9. 运行代码`fig.add_subplot（2，2，0）`生成的是2×2图片中的第一个子图（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**11. 绘制图表时可以通过传递`label`参数添加图例来区分不同的绘图元素 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**12. DataFrame对象调用`plot`方法时，可以通过传递`subplots=True`来使得对象的每一列绘制在独立的子图中（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**13. `plt.plot([2,3, 6, 7,8], 'g--o')`与`plt.plot([2,3, 6, 7,8], 'go--')`生成的图形不一样。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**14. pandas对象的`plot.barh`方法绘制的是垂直的柱状图（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**16. matplotlib绘制的图位于Figure对象中，可以使用`plt.figure()`调用 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**17. 通过使用`shareX`、`shareY`可以使得子图分别拥有相同的x轴和y轴 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**18. `set_xticks`在数据范围内设定刻度的位置，而不设置刻度的标签。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**19. `plt.savefig`函数可以将图片保存到文件中，并且只能以`svg`格式存储（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**21. 假设有一个figure对象`fig`，则`fig.add_subplot(224)`和`fig.add_subplot(2,2,4)`执行的结果相同。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**22. 默认情况下，Series和DataFrame的`plot()`方法绘制的是条形图（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**23. `fig=plt.figure()`随后`fig.plot()`没有问题。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**25. 代码`plt.xlim（[0, 10]）`的目的是将x轴的范围设置为0到10。 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**26. 使用`value_counts:s.value_counts().plot.bar()`可以有效地对Series值进行可视化。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**27. `plt.subplots`方法可以创建一个新的Figure，并返回一个含有已创建的subplot对象的NumPy数组。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
**1. 调用`groupby`方法生成一个GroupBy对象可以直接进行输出。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**5. 使用`groupby`方法分组时分组键可以是多种形式的，而且键的类型也不一定完全相同（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**10. `Crosstab`的前两个参数可以是数组、Series、或者数组的列表（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**11. 对于`groupby`中的`size`方法，分组键中的任何缺失值都会被排除在结果之外（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**12. `apply`方法是将对象拆分为多块，在每一块都会调用传递的函数（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**13. 使用字典构造传给`groupby`的数组时，字典的键必须与对象的长度一致（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**14. 默认情况下，`groupby`在`axis = 1`的轴向上分组（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**17. 在没有特定指明对DataFrame对象的哪一列进行计算时，`agg`方法默认情况下会对所有的数值列进行聚合（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**18. ...执行`df.groupby(['key1','key2'])['data2'].mean()`可以获得`data2`列的均值并以DataFrame的形式返回结果（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**19. 若`df`是一个DataFrame对象，则默认情况下，`df`中的所有的数值列都可以聚合。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**20. 假设有DataFrame对象`df`，`key1`是`df`中的列，则`df.groupby('key1').mean()`等价于`df.groupby(['key1']).mean()`。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**23. `groupby`的参数只可以是列名，不可以是index名。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**26. 返回的聚合数据...取消这种模式，在调用`groupby`的时候设定`as_index=True`即可。 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**27. `cut`返回的Categorical对象不能直接传递给`groupby` （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**28. `pandas`提供了`crosstab()`函数...返回新的`DataFrame`对象。 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**30. 在用`groupby`方法对DataFrame对象进行分组处理时，...可以是字符串类型的列名、其他python对象...以及python的函数。 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**32. 由于`quantile`并不是显式的为GroupBy对象实现的，因此不能用于聚合 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
**1. `datetime.strptime`可以在已知格式的情况下转换日期。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**3. `Timestamp`与`datetime`都是时间类型，但是`timestamp`只使用`datetime`一半的存储空间。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**8. `resample`后使用`ohlc`聚合函数可以获得包含开端-峰值-谷值-结束四种聚合值列的DataFrame（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**9. 在`date_range`的`freq`参数传入“1h10min”是无效的（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**12. 所有使用`datetime`对象的地方都可以使用`Timestamp`（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**16. 当获得包含时间信息的时间戳时...可以将`normalize`设置为True。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**19. 进行重新采样时，将`W-WED`转换到`W-FRI`属于向下采样（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**20. 运行代码`pd.to_datetime(['2000-1-1','31-12-2000','8-31-2000'])`会报错（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**21. 当把`datetime`类型的数据作为索引时，数据类型变为`DatetimeIndex`。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**22. `timedelta`可以查看`days`和`seconds`而不能查看`minutes`。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**23. `resample`函数得`loffset`参数可以用`shift`实现（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**25. `date_range()`函数生产日期时间数据时，如果以6天为间隔可以设置参数`freq`为`‘6D’`。( )**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**28. `resample` 的方法参数中，`convention`的默认值为`‘start’`（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**4. 对于Series中的分类方法，`rename_categories`和`set_categories`...但前者不能改变类别的数量，而后者可以添加或删除类别（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**5. 对一个Categorical进行`set_categories`操作，赋值给一个新的对象，不会影响到新对象的类别。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**6. `pipe`方法的一个潜在用途是将操作的序列泛化成可复用的函数（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**7. `pandas.qcut`生成的结果的数据类型是`pandas.Categorical`（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**8. `df2=df.copy(),df2['k']=v`与`df2=df.assign(k=v)`是等价的（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**9. `...pd.unique(values)`返回的结果是`FALSE` （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**10. `transform`可以产生一个标量值，并广播到各分组的尺寸数据中。（ ）**
<details>
  <summary style="font-weight: bold; cursor:pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**11. Categorical对象的`codes`属性对应的`dtype`为`float64`（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**16. 使用`TimeGrouper`时，时间必须是Series或者DataFrame索引 （ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**17. `DataFrame.assign`方法可以按指定修改原DataFrame（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**19. `fruits_cat = df['fruit'].astype('category')`得到的`fruits_cat`是一个Numpy数组。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**20. 通过`pandas.qcut`分箱函数生成的`Categories`对象的类别已经指定了顺序（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**21. `take`函数得到的Series的索引是`values`的值。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**23. pandas的`TimeGrouper`可以使用`Grouper`替代（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**24. `remove_categories`将移除类别所对应的值。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
...
---
**27. 对一个Categorical进行`set_categories`操作，赋值给一个新的对象，会影响到新对象的类别。（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 正确 (True)
...
---
**29. `Categories`对象的`categories`属性...`codes`属性...（ ）**
<details>
  <summary style="font-weight: bold; cursor: pointer; color: #007bff;">点击查看解析</summary>
  <br>
  **正确答案：** 错误 (False)
